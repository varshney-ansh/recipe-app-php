<div class="h-screen bg-bg-white-smoke w-full ">
            <div class="h-[36px] pt-1.5 pb-1.5  w-full mt-3 mb-3 flex justify-between items-center px-4">
                <div class="flex items-center justify-between gap-2">
                    ...
                    <h1 class="font-qurova font-[500] text-text-black text-2xl">Activities</h1>
                </div>
                <div>
                    <div>
                            ...
                            chatMessages.forEach(message => {
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width="32" height="32" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: 100%; transform: translate3d(0px, 0px, 0px); content-visibility: visible;">
                                    <defs>
                                        ...
                                        <linearGradient id="__lottie_element_1391" spreadMethod="pad" gradientUnits="userSpaceOnUse" x1="-33" y1="26" x2="31" y2="-28">
                                            <stop offset="0%" stop-color="rgb(52,107,241)"></stop>
                                            <stop offset="22%" stop-color="rgb(50,121,248)"></stop>
                                            <stop offset="45%" stop-color="rgb(49,134,255)"></stop>
                                            <stop offset="72%" stop-color="rgb(64,147,255)"></stop>
